...
SECRET_KEY = 'django-insecure-@0+u*)t7l(1x06%6-%^-6(%42j^b-qfbap&kg+z&_cs$mmyzj_'
...
DATABASES = {
    ...
    'default': {
        ...
        'USER': 'user',
        'PASSWORD': 'admin@123',
        'HOST': 'cinemabd.mysql.database.azure.com',   # Or an IP Address that your DB is hosted on
        'PORT': '3306',
    }
}
